...
cSceneCamera::cSceneCamera(cGame	*apGame,
						   float	 afSpeed,
						   cVector3f avStartPos,
						   bool		 abShowFPS) : iUpdateable("SceneCamera")
{
	mpGame = apGame;
	mfSpeed = afSpeed;
...
void cSceneCamera::OnDraw()
{
	if(mpFont)
	{
		mpFont->Draw(cVector2f(5,5),12,cColor(1,1), eFontAlign_Left,
